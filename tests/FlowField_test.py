...
def build_up():
    ...
    turbine = Turbine(instance_dictionary)
...
def test_instantiation():
    ffdict = build_up()
    assert FlowField(ffdict["wind_speed"],
                     ffdict["wind_direction"],
                     ffdict["wind_shear"],
                     ffdict["wind_veer"],
                     ffdict["turbulence_intensity"],
                     ffdict["wake"],
                     ffdict["wake_combination"],
                     ffdict["turbine_map"]) != None
