...
def test_asdict(sample_inputs_fixture: SampleInputs):
    ...
    farm.set_helix_amplitudes_to_ref_amp(N_FINDEX)
    farm.set_helix_frequencies_to_ref_freq(N_FINDEX)
    dict1 = farm.as_dict()
    ...
    new_farm.set_helix_amplitudes_to_ref_amp(N_FINDEX)
    new_farm.set_helix_frequencies_to_ref_freq(N_FINDEX)
