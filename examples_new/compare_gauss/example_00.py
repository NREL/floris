...
saved_gauss[(10,0)] = [
    ...
    np.array([
        1533.60441684, 1365.62088487, 1155.08543545,  973.56022679,
...
saved_gauss[(10,20)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1240.69409842, 1054.31942699,  964.51369145, 1018.28384293,
...
saved_gauss[(6,0)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1582.68316317, 1366.9223727 , 1026.53731597,  692.43879565,
...
saved_gauss[(6,20)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1331.00738281,  987.67770715,  695.83692699,  647.76067736,
...
saved_gauss[(3,0)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1610.71175613, 1373.78219575,  949.99041557,  509.82923117,
...
saved_gauss[(3,20)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1531.15831746, 1193.3884595 ,  745.50596379,  428.65487254,
...
saved_gauss[(10,"gain")] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        -19.09947019, -22.79559879, -16.4984977 ,   4.5938212 ,
...
saved_gauss[(6,"gain")] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        -15.90184228, -27.74441864, -32.21513566,  -6.4522841 ,
...
saved_gauss[(3,"gain")] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        -4.9390239 , -13.13117442, -21.5248963 , -15.9218722 ,
