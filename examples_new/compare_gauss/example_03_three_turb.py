...
def power_cross_sweep(fi_in,D,dist_downstream,yaw_angle=0):
    ...
    for y_idx, y_loc in enumerate(sweep_locations):
            ...
            [0,dist_downstream*D,dist_downstream*D*2], [0,0,y_loc*D]
        ))
...
def power_cross_sweep_gain(fi_in,D,dist_downstream,yaw_angle=0):
    ...
    for y_idx, y_loc in enumerate(sweep_locations):
        ...
        power_out[y_idx] = \
            100 * (fi.get_turbine_power()[2]/1000. - base_power) / base_power
...
saved_gauss[(10,0)] = [
    ...
    np.array([
        1435.94370406, 1323.89503547, 1217.15795972, 1140.26658923,
...
saved_gauss[(10,20)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1337.24318379, 1254.84555316, 1186.68781729, 1146.78010767,
...
saved_gauss[(6,0)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1438.93360213, 1232.23167916, 1000.43763306,  816.19974529,
...
saved_gauss[(6,20)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1226.76528778, 1044.48135074,  897.85075458,  816.61889812,
...
saved_gauss[(3,0)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1505.19140631, 1199.59728334,  775.07370251,  399.30350983,
...
saved_gauss[(3,20)] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        1314.00611798,  931.18272859,  547.7518679 ,  319.60029603,
...
saved_gauss[(10,"gain")] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        -6.87356475, -5.21563118, -2.5033844 ,  0.57122768,  3.30365232,
...
saved_gauss[(6,"gain")] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        -14.74483006, -15.23660945, -10.25420027,   0.0513542 ,
...
saved_gauss[(3,"gain")] = [
    np.array([-1.  , -0.75, -0.5 , -0.25,  0.  ,  0.25,  0.5 ,  0.75,  1.  ]),
    np.array([
        -12.70172601, -22.37538868, -29.32906043, -19.96055928,
