...
def ti_sweep(fi_in,D,dist_downstream,yaw_angle=0):
    ...
    for ti_idx, ti in enumerate(ti_values):
              ...
              layout_array=([0,dist_downstream*D],[0,0]),
...
saved_gauss[(10,0)] = [
       ...
       np.array([
              710.37278464,  761.44551604,  810.51984522,  857.39042285,
...
saved_gauss[(10,20)] = [
       ...
       np.array([
              1177.8352177 , 1176.39581191, 1177.56634904, 1181.3229298 ,
...
saved_gauss[(6,0)] = [
       ...
       np.array([
              395.38103375 , 428.21405187,  468.39667203,  508.72400682,
...
saved_gauss[(6,20)] = [
       ...
       np.array([
               814.63964374,  830.21807143,  848.73912014,  866.16946293,
...
saved_gauss[(3,0)] = [
       ...
       np.array([
              272.16015991, 281.11187872, 289.94778828, 298.67718779,
...
saved_gauss[(3,20)] = [
       ...
       np.array([
              483.05378444, 490.3244278 , 497.505388  , 504.60258843,
...
saved_gauss[(10,"gain")] = [
       ...
       np.array([
              65.80522835, 54.49507379, 45.28531978, 37.78121359, 31.65495156,
...
saved_gauss[(6,"gain")] = [
       ...
       np.array([
              106.03913041,  93.87922181,  81.20092879,  70.26313902,
...
saved_gauss[(3,"gain")] = [
       ...
       np.array([
              77.48879358, 74.42323321, 71.58447421, 68.94580807, 66.48484027,
