...
if __name__ == "__main__":
    ...
    fi.calculate_AEP_wind_limit(10, 5, 15, 0.001)
    ...
    mask = ws_list < fi.ws_limit
    mask_inv = [not val for val in mask]
    AEP_add = np.sum(freq[mask_inv] * fi.max_power)

    power_result = fi.get_farm_AEP_parallel(wd_list[mask], ws_list[mask], freq[mask])
