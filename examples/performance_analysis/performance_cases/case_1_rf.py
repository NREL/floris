...
# In the first case, simply time 10 calls to reiniinialize flow field
...
N = 100  # Number of iterations in timing loop
num_turbine = 5
...
if recompute_baseline:
    pickle.dump(turbine_powers, open("result_case_1.p", "wb"))
else:
    saved_result = pickle.load(open("result_case_1.p", "rb"))
