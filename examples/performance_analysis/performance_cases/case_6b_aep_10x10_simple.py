...
# Report the timing
print("====RESULT====")
print("*** 10x10 AEP takes on average %.1f seconds" % (elapsed_time))
print("*** exact result in s -> %f" % elapsed_time)

# Now check if result has changed
if recompute_baseline:
    pickle.dump(power_result, open("result_case_6b.p", "wb"))
else:
    saved_result = pickle.load(open("result_case_6b.p", "rb"))
