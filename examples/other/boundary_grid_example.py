...
import floris.tools.boundary_grid as BG
...
bg.reinitialize_bg(n_boundary_turbs=n_boundary_turbs,start=start,nrows=nrows,ncols=ncols,farm_width=farm_width,
                    farm_height=farm_height,shear=shear,rotation=rotation,center_x=center_x,center_y=center_y,
                    shrink_boundary=shrink_boundary,boundary_x=boundary_x,boundary_y=boundary_y)
