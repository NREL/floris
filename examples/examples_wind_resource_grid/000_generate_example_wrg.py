...
# Assume that the wind roses at other points are generated by rotating
# the wind rose as y increases increasing the velocity as x increases.
x_list = []
y_list = []
wind_rose_list = []
n_bins_per_step = 1
...
for xi in range(Nx):
    for yi in range(Ny):
        ...
        # Scale the wind rose
        scale_vector = np.linspace(
            1 - scale_factor * xi, 1 + scale_factor * xi, freq_table.shape[1]
        )
