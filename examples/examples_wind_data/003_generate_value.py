...
def custom_value_func(wind_directions: np.ndarray, wind_speeds: np.ndarray) -> np.ndarray:  # noqa ARG001
...
wind_rose.assign_value_piecewise_linear(
    value_zero_ws=1.425, ws_knee=4.5, slope_1=0.0, slope_2=-0.135
)
fig, ax = plt.subplots()
wind_rose.plot_value_over_ws(ax)
