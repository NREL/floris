...
1.420906 | 27.515838 |  28.936744  <- dropping reassignment from np.array(boolean operation)
                                        as of 3:35 8/15/22
1.536173 | 28.122597 |  29.658770  <- common variable for reused calculations and more booleans
                                        like the above as of 3:55 8/15/22
1.477387 | 27.615849 |  29.093236  <- gamma parameters to a single function and undo slow change
                                        from above as of 4:25 8/15/22
1.450766 | 27.384075 |  28.834841  <- vortex calculation addition
1.366653 | 23.887163 |  25.253816  <- update vortex calculation and apply it to transverse
                                        velocity as of 11:28 8/16/22
...
Restart and rerun on develop as of 5:00 8/16/22
1.442052 | 27.290215 |  28.732267 <- 26.87% speedup as of last modification
"""
