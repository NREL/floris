...
from floris.tools.visualization import VelocityProfilesFigure, visualize_cut_plane
...
coefficients is used, which allows the wake to have different characteristics in the
