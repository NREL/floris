...
horizontal_plane = fi.calculate_horizontal_plane(x_resolution=200, y_resolution=100, height=90.0, yaw_angles=np.array([[[25.,0.,0.]]]))
y_plane = fi.calculate_y_plane(x_resolution=200, z_resolution=100, crossstream_dist=630.0, yaw_angles=np.array([[[25.,0.,0.]]]))
cross_plane = fi.calculate_cross_plane(y_resolution=100, z_resolution=100, downstream_dist=630.0, yaw_angles=np.array([[[25.,0.,0.]]]))
...
horizontal_plane_scan_turbine = calculate_horizontal_plane_with_turbines(fi, x_resolution=20, y_resolution=10, yaw_angles=np.array([[[25.,0.,0.]]]))
