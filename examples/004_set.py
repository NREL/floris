...
# Note the dimension must match (n_findex, n_tindex) or (number of conditions, number of turbines)
# Above we n_findex = 3 and n_tindex = 2 so the matrix of yaw angles must be 3x2
yaw_angles = np.array([[0.0, 0.0], [25.0, 0.0], [0.0, 0.0]])
fmodel.set(yaw_angles=yaw_angles)

# By default for the turbines in the turbine_libary, the power
