...
fi.reinitialize( layout=( [0, 500., 1000., 0, 500., 1000.], [0., 0., 0., 500., 500., 500.] ) )
...
loaded77 = np.loadtxt('analytic_power_77.txt')
...
plt.ylabel('Power [kW]')
plt.xlabel('Wind Speed [m/s]')
plt.title('Comparison of the Freestream turbines at max power')
plt.show()
