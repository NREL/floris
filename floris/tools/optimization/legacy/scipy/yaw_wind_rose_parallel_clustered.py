...
class YawOptimizationWindRoseParallelClustered(YawOptimizationWindRoseClustered, LoggerBase):
    ...
    the turbines into seperate subsets (clusters) in which the turbines witin
    each subset exclusively interact with one another and have no impact on turbines
    ...
    independent). This class additionally facilitates parallel optimization
    using the MPIPoolExecutor method of the mpi4py.futures module.
    """
